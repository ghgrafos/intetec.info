...
<div class="container theme-showcase" role="main">
	...
	<div class="row espaco">
		<div class="pull-right">
			<a href="admin_routes.php?link=11"><button type='button' class='btn btn-sm btn-success'>Cadastrar</button></a>
		</div>
	</div>
	<div class="row">
        <div class="col-md-12">
					...
					<?php while($row_situacoes = mysqli_fetch_assoc($resultado_situacoes)){?>
						<tr>
							...
							<td class="text-center">
								<a href="admin_routes.php?link=13&id=<?php echo $row_situacoes["id"]; ?>">
									<button type="button" class="btn btn-xs btn-primary">
										Visualizar
									</button>
								</a>
								<a href="admin_routes.php?link=12&id=<?php echo $row_situacoes["id"]; ?>">
									<button type="button" class="btn btn-xs btn-warning">
										Editar
									</button>
								</a>
								<a href="admin_routes/processa/adm_apagar_situacoes.php?id=<?php echo $row_situacoes["id"]; ?>">
