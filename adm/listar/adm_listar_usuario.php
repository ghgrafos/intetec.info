...
<div class="container theme-showcase" role="main">
	...
	<div class="row espaco">
		<div class="pull-right">
			<a href="admin_routes.php?link=3"><button type='button' class='btn btn-sm btn-success'>Cadastrar</button></a>
		</div>
	</div>
	<div class="row">
        <div class="col-md-12">
				...
				<tbody>
					<?php while($row_usuarios = mysqli_fetch_assoc($resultado_usuarios)){?>
						<tr>
							...
							<td class="text-center">
								<a href="admin_routes.php?link=5&id=<?php echo $row_usuarios["id"]; ?>">
									<button type="button" class="btn btn-xs btn-primary">
										Visualizar
									</button>
								</a>
								<a href="admin_routes.php?link=4&id=<?php echo $row_usuarios["id"]; ?>">
									<button type="button" class="btn btn-xs btn-warning">
										Editar
									</button>
								</a>
								<a href="admin_routes/processa/adm_apagar_usuario.php?id=<?php echo $row_usuarios["id"]; ?>">
