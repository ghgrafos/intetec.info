...
<div class="container theme-showcase" role="main">
	...
	<div class="row espaco">
		<div class="pull-right">
			<a href="admin_routes.php?link=7"><button type='button' class='btn btn-sm btn-success'>Cadastrar</button></a>
		</div>
	</div>
	<div class="row">
        <div class="col-md-12">
					...
					<?php while($row_niveis_acessos = mysqli_fetch_assoc($resultado_niveis_acessos)){?>
						<tr>
							...
							<td class="text-center">
								<a href="admin_routes.php?link=9&id=<?php echo $row_niveis_acessos["id"]; ?>">
									<button type="button" class="btn btn-xs btn-primary">
										Visualizar
									</button>
								</a>
								<a href="admin_routes.php?link=8&id=<?php echo $row_niveis_acessos["id"]; ?>">
									<button type="button" class="btn btn-xs btn-warning">
										Editar
									</button>
								</a>
								<a href="admin_routes/processa/adm_apagar_nivel_acesso.php?id=<?php echo $row_niveis_acessos["id"]; ?>">
