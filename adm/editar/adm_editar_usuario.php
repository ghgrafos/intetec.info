...
<div class="container theme-showcase" role="main">
	...
	<div class="row">
		<div class="pull-right" style="padding-bottom: 20px; ">
			<a href="admin_routes.php?link=2"><button type='button' class='btn btn-sm btn-success'>Listar</button></a>
		</div>
	</div>
	<form class="form-horizontal" method="POST" action="processa/adm_proc_edita_usuario.php" enctype="multipart/form-data">
