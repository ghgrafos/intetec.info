...
<html lang="pt-br">
	...
	<body> <?php
		if(mysqli_affected_rows($conn) != 0){
			echo "
				<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://198.162.1.3/adm/admin_route.php?link=2'>
			...
			echo "
				<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://192.162.1.3/adm/admin_routes.php?link=2'>
				<script type=\"text/javascript\">
